...
ThreadedObject::~ThreadedObject() { SDL_DestroySemaphore(m_sem); }

void ThreadedObject::pause() { m_isPausing = true; }
...
bool ThreadedObject::isPausing() { return m_isPausing; }

bool ThreadedObject::isRunning() { return m_isRunning; }
...
void ThreadedObject::notifyFinish() { m_isRunning = false; }
