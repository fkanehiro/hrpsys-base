...
const char* GLbodyRTC::glbodyrtc_spec[] = {
    "implementation_id", "GLbodyRTC", "type_name", "GLbodyRTC", "description",
    "GLbodyRTC component", "version", "0.1", "vendor", "AIST", "category",
...
void GLbodyRTC::moduleInit(RTC::Manager* manager) {
  ...
  manager->registerFactory(
      profile, RTC::Create<GLbodyRTC>, DummyDelete<GLbodyRTC>
