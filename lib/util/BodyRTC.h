...
class RobotHardwareServicePort
 ...
 public:
  ...
  CORBA::Boolean power(const char *jname,
                       OpenHRP::RobotHardwareService::SwitchStatus ss);
  CORBA::Boolean servo(const char *jname,
                       OpenHRP::RobotHardwareService::SwitchStatus ss);
...
class BodyRTC : virtual public hrp::Body, public RTC::DataFlowComponentBase {
 public:
  ...
  bool power(int jid, bool turnon) {
    power_status[jid] = turnon ? OpenHRP::RobotHardwareService::SWITCH_ON
                               : OpenHRP::RobotHardwareService::SWITCH_OFF;
  }
  bool servo(const char *jname, bool turnon);
  bool servo(int jid, bool turnon) {
    servo_status[jid] = turnon ? OpenHRP::RobotHardwareService::SWITCH_ON
                               : OpenHRP::RobotHardwareService::SWITCH_OFF;
  }
  ...
  // bool addJointGroup(const char *gname, const std::vector<std::string>&
  // jnames);
