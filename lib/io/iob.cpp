...
#define CHECK_JOINT_ID(id) \
  if ((id) < 0 || (id) >= number_of_joints()) return E_ID
#define CHECK_FORCE_SENSOR_ID(id) \
  if ((id) < 0 || (id) >= number_of_force_sensors()) return E_ID
#define CHECK_ACCELEROMETER_ID(id) \
  if ((id) < 0 || (id) >= number_of_accelerometers()) return E_ID
#define CHECK_GYRO_SENSOR_ID(id) \
  if ((id) < 0 || (id) >= number_of_gyro_sensors()) return E_ID
#define CHECK_ATTITUDE_SENSOR_ID(id) \
  if ((id) < 0 || (id) >= number_of_attitude_sensors()) return E_ID
...
int number_of_joints() { return (int)command.size(); }

int number_of_force_sensors() { return (int)forces.size(); }

int number_of_gyro_sensors() { return (int)gyros.size(); }

int number_of_accelerometers() { return (int)accelerometers.size(); }

int number_of_attitude_sensors() { return (int)attitude_sensors.size(); }
...
int read_actual_torques(double *torques) { return FALSE; }

int read_command_torque(int id, double *torque) { return FALSE; }

int write_command_torque(int id, double torque) { return FALSE; }

int read_command_torques(double *torques) { return FALSE; }

int write_command_torques(const double *torques) { return FALSE; }
...
int read_pgain(int id, double *gain) { return FALSE; }

int write_pgain(int id, double gain) { return FALSE; }

int read_dgain(int id, double *gain) { return FALSE; }

int write_dgain(int id, double gain) { return FALSE; }

int read_force_sensor(int id, double *forces) {
  for (int i = 0; i < 6; i++) {
    forces[i] = ((double)random() - RAND_MAX / 2) / (RAND_MAX / 2) * 2 + 2 +
                force_offset[id][i];  // 2 = initial offset
  }
  return TRUE;
}
...
int read_accelerometer(int id, double *accels) {
  for (int i = 0; i < 3; i++) {
    ...
    accels[i] = (i == 2 ? (9.8 + randv) : randv) + 0.01 +
                accel_offset[id][i];  // 0.01 = initial offset
  }
  return TRUE;
}

int read_touch_sensors(unsigned short *onoff) { return FALSE; }

int read_attitude_sensor(int id, double *att) { return FALSE; }

int read_current(int id, double *mcurrent) { return FALSE; }

int read_current_limit(int id, double *v) { return FALSE; }

int read_currents(double *currents) { return FALSE; }

int read_gauges(double *gauges) { return FALSE; }

int read_actual_velocity(int id, double *vel) { return FALSE; }

int read_command_velocity(int id, double *vel) { return FALSE; }

int write_command_velocity(int id, double vel) { return FALSE; }

int read_actual_velocities(double *vels) { return FALSE; }

int read_command_velocities(double *vels) { return FALSE; }

int write_command_velocities(const double *vels) { return FALSE; }

int read_temperature(int id, double *v) { return FALSE; }
...
int write_dio(unsigned short buf) { return FALSE; }
...
int joint_calibration(int id, double angle) { return FALSE; }
...
int write_attitude_sensor_offset(int id, double *offset) { return FALSE; }
...
int read_lock_owner(pid_t *pid) { return FALSE; }

int read_limit_angle(int id, double *angle) { return FALSE; }

int read_angle_offset(int id, double *angle) { return FALSE; }

int write_angle_offset(int id, double angle) { return FALSE; }

int read_ulimit_angle(int id, double *angle) { return FALSE; }
int read_llimit_angle(int id, double *angle) { return FALSE; }
int read_encoder_pulse(int id, double *ec) { return FALSE; }
int read_gear_ratio(int id, double *gr) { return FALSE; }
int read_torque_const(int id, double *tc) { return FALSE; }
int read_torque_limit(int id, double *limit) { return FALSE; }
...
int number_of_substeps() { return 5; }
...
int number_of_batteries() { return 1; }
...
int number_of_thermometers() { return 0; }
...
size_t length_of_extra_servo_state(int id) { return 0; }

int read_extra_servo_state(int id, int *state) { return TRUE; }
...
long get_signal_period() { return g_period_ns; }
...
int read_digital_input(char *dinput) { return FALSE; }

int length_digital_input() { return 0; }

int write_digital_output(const char *doutput) { return FALSE; }

int write_digital_output_with_mask(const char *doutput, const char *mask) {
  return FALSE;
}

int length_digital_output() { return 0; }

int read_digital_output(char *doutput) { return FALSE; }
