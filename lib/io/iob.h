 ...
 * @param angles	array of joint angle[rad], length of array must be equal
 * to
 * number_of_joints()
 * @retval TRUE this function is supported
 * @retval FALSE otherwise
 ...
 * @param torques	array of actual joint torque[Nm], length of array must
 * be
 * equal to number_of_joints()
 * @retval TRUE this function is supported
 * @retval FALSE otherwise
 */
 ...
 * @param angles	array of joint angles[rad], length of array must equal
 * to
 * DOF
 * @retval TRUE this function is supported
 * @retval FALSE otherwise
 ...
 * @param forces	array of forces[N] and moments[Nm], length of array must
 * be
 * 6
 * @return		TRUE or E_ID
 */
...
/**
 * @brief		read status of battery source this is new API since
 * 315.4.0
 * @param id	battery id
 * @param v		voltage[V]
 * @param a		current[A]
