...
double PyLink::getPosture() { return q; }
...
void PyLink::addShapeFromFile(std::string url) {
  ...
  OpenHRP::ModelLoader_var modelloader = hrp::getModelLoader(
...
PyLink *PyLink::getParent() { return (PyLink *)parent; }
...
int PyLink::getJointId() { return jointId; }
