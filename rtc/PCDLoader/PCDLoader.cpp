...
static const char *spec[] = {
    "implementation_id", "PCDLoader", "type_name", "PCDLoader", "description",
    "PCD file loader", "version", HRPSYS_PACKAGE_VERSION, "vendor", "AIST",
...
void PCDLoaderInit(RTC::Manager *manager) {
  ...
  manager->registerFactory(profile, RTC::Create<PCDLoader>,
