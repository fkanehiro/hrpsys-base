...
static const char* imagedata2cameraimage_spec[] = {
    "implementation_id", "ImageData2CameraImage", "type_name",
    "ImageData2CameraImage", "description", "imagedata2cameraimage component",
...
void ImageData2CameraImageInit(RTC::Manager* manager) {
  ...
  manager->registerFactory(profile, RTC::Create<ImageData2CameraImage>,
