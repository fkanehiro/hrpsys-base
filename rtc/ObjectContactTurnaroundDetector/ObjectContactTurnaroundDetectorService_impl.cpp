...
void ObjectContactTurnaroundDetectorService_impl::
    startObjectContactTurnaroundDetection(
        const CORBA::Double i_ref_diff_wrench, const CORBA::Double i_max_time,
        const OpenHRP::ObjectContactTurnaroundDetectorService::StrSequence&
            i_ee_names) {
  m_otd->startObjectContactTurnaroundDetection(i_ref_diff_wrench, i_max_time,
                                               i_ee_names);
}
...
CORBA::Boolean ObjectContactTurnaroundDetectorService_impl::
    getObjectContactTurnaroundDetectorParam(
        OpenHRP::ObjectContactTurnaroundDetectorService::
            objectContactTurnaroundDetectorParam& i_param_) {
  i_param_ = OpenHRP::ObjectContactTurnaroundDetectorService::
      objectContactTurnaroundDetectorParam();
  return m_otd->getObjectContactTurnaroundDetectorParam(i_param_);
}

CORBA::Boolean
ObjectContactTurnaroundDetectorService_impl::getObjectForcesMoments(
...
void ObjectContactTurnaroundDetectorService_impl::otd(
    ObjectContactTurnaroundDetector* i_otd) {
  m_otd = i_otd;
}
