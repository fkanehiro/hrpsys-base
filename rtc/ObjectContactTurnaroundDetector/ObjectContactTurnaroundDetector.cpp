...
static const char* objectcontactturnarounddetector_spec[] = {
    "implementation_id", "ObjectContactTurnaroundDetector", "type_name",
    "ObjectContactTurnaroundDetector", "description",
    "object contact turnaround detector component", "version",
...
RTC::ReturnCode_t ObjectContactTurnaroundDetector::onInitialize() {
  ...
  m_ObjectContactTurnaroundDetectorServicePort.registerProvider(
      "service0", "ObjectContactTurnaroundDetectorService", m_service0);
  ...
  std::cerr << "[" << m_profile.instance_name << "] Add sensor_names"
            << std::endl;
  for (unsigned int i = 0; i < m_forceIn.size(); i++) {
    ...
    if (!is_ee_exists) {
      std::cerr << "[" << m_profile.instance_name
                ...
                << sensor_link_name << "!!. sensor_name for " << sensor_name
    ...
    std::cerr << "[" << m_profile.instance_name
              ...
              << ", ee_name = " << ee_name
              << ", ee-link = " << ee_map[ee_name].target_name << std::endl;
  }

  otd = boost::shared_ptr<ObjectContactTurnaroundDetectorBase>(
      new ObjectContactTurnaroundDetectorBase(m_dt));
...
/*
  RTC::ReturnCode_t ObjectContactTurnaroundDetector::onStartup(RTC::UniqueId
  ec_id)
  {
  return RTC::RTC_OK;
  }
...
/*
  RTC::ReturnCode_t ObjectContactTurnaroundDetector::onShutdown(RTC::UniqueId
  ec_id)
  {
  return RTC::RTC_OK;
  }
...
RTC::ReturnCode_t ObjectContactTurnaroundDetector::onActivated(
    RTC::UniqueId ec_id) {
...
RTC::ReturnCode_t ObjectContactTurnaroundDetector::onDeactivated(
    RTC::UniqueId ec_id) {
...
RTC::ReturnCode_t ObjectContactTurnaroundDetector::onExecute(
    RTC::UniqueId ec_id) {
  // std::cout << "ObjectContactTurnaroundDetector::onExecute(" << ec_id << ")"
  // << std::endl;
  loop++;
...
/*
  RTC::ReturnCode_t ObjectContactTurnaroundDetector::onAborting(RTC::UniqueId
  ec_id)
  {
  return RTC::RTC_OK;
  }
...
/*
  RTC::ReturnCode_t ObjectContactTurnaroundDetector::onError(RTC::UniqueId
  ec_id)
  {
  return RTC::RTC_OK;
  }
...
/*
  RTC::ReturnCode_t ObjectContactTurnaroundDetector::onReset(RTC::UniqueId
  ec_id)
  {
  return RTC::RTC_OK;
  }
...
/*
  RTC::ReturnCode_t ObjectContactTurnaroundDetector::onStateUpdate(RTC::UniqueId
  ec_id)
  {
  return RTC::RTC_OK;
  }
...
/*
  RTC::ReturnCode_t ObjectContactTurnaroundDetector::onRateChanged(RTC::UniqueId
  ec_id)
  {
  return RTC::RTC_OK;
  }
...
void ObjectContactTurnaroundDetector::calcFootMidCoords(
...
void ObjectContactTurnaroundDetector::
    calcObjectContactTurnaroundDetectorState() {
  // TODO
  ...
  for (unsigned int i = 0; i < m_forceIn.size(); i++) {
    std::string sensor_name = m_forceIn[i]->name();
    if (find(otd_sensor_names.begin(), otd_sensor_names.end(), sensor_name) !=
        otd_sensor_names.end()) {
      hrp::ForceSensor* sensor = m_robot->sensor<hrp::ForceSensor>(sensor_name);
      ...
      for (std::map<std::string, ee_trans>::iterator it = ee_map.begin();
        ...
        if (it->second.sensor_name == sensor_name) {
          ...
          eePos =
              fmrotT * (target_link->p + target_link->R * eet.localPos - fmpos);
        }
      }
...
void ObjectContactTurnaroundDetector::updateRootLinkPosRot(
...
void ObjectContactTurnaroundDetector::startObjectContactTurnaroundDetection(
...
ObjectContactTurnaroundDetector::checkObjectContactTurnaroundDetection() {
...
bool ObjectContactTurnaroundDetector::setObjectContactTurnaroundDetectorParam(
  ...
  otd->setDetectorTotalWrench(
      (i_param_.detector_total_wrench ==
       OpenHRP::ObjectContactTurnaroundDetectorService::TOTAL_FORCE)
          ? ObjectContactTurnaroundDetectorBase::TOTAL_FORCE
          : ObjectContactTurnaroundDetectorBase::TOTAL_MOMENT);
  otd->printParams();
  return true;
};

bool ObjectContactTurnaroundDetector::getObjectContactTurnaroundDetectorParam(
  ...
  i_param_.detector_total_wrench =
      (otd->getDetectorTotalWrench() ==
       ObjectContactTurnaroundDetectorBase::TOTAL_FORCE)
          ? OpenHRP::ObjectContactTurnaroundDetectorService::TOTAL_FORCE
          : OpenHRP::ObjectContactTurnaroundDetectorService::TOTAL_MOMENT;
  return true;
}

bool ObjectContactTurnaroundDetector::getObjectForcesMoments(
    OpenHRP::ObjectContactTurnaroundDetectorService::Dbl3Sequence_out o_forces,
    ...
    OpenHRP::ObjectContactTurnaroundDetectorService::DblSequence3_out
        o_3dofwrench) {
  std::cerr << "[" << m_profile.instance_name << "] getObjectForcesMoments"
            << std::endl;
