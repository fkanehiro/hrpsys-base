...
#ifndef CAMERA_IMAGE_LOADER_H
#define CAMERA_IMAGE_LOADER_H
...
/**
   ...
   port
 */
class CameraImageLoader : public RTC::DataFlowComponentBase {
 public:
  /**
     \brief Constructor
