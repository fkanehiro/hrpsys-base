...
CORBA::Boolean
RemoveForceSensorLinkOffsetService_impl::setForceMomentOffsetParam(
    const char *i_name_,
...
CORBA::Boolean
RemoveForceSensorLinkOffsetService_impl::getForceMomentOffsetParam(
    const char *i_name_,
    OpenHRP::RemoveForceSensorLinkOffsetService::forcemomentOffsetParam_out
        i_param_) {
  i_param_ =
      new OpenHRP::RemoveForceSensorLinkOffsetService::forcemomentOffsetParam();
...
CORBA::Boolean
RemoveForceSensorLinkOffsetService_impl::loadForceMomentOffsetParams(
    const char *filename) {
  return m_rmfsoff->loadForceMomentOffsetParams(std::string(filename));
};

CORBA::Boolean
RemoveForceSensorLinkOffsetService_impl::dumpForceMomentOffsetParams(
    const char *filename) {
  return m_rmfsoff->dumpForceMomentOffsetParams(std::string(filename));
};

CORBA::Boolean RemoveForceSensorLinkOffsetService_impl::removeForceSensorOffset(
    const ::OpenHRP::RemoveForceSensorLinkOffsetService::StrSequence &names,
    CORBA::Double tm) {
  return m_rmfsoff->removeForceSensorOffset(names, tm);
}

void RemoveForceSensorLinkOffsetService_impl::rmfsoff(
