...
bool VclipLinkPair::checkCollision()
{
    ...
    hrp::Vector3  p1 = links_[0]->p;
    hrp::Matrix33 r1 = links_[0]->attitude();
    hrp::Vector3  p2 = links_[1]->p;
    hrp::Matrix33 r2 = links_[1]->attitude();
    R1.xrow().set(r1(0,0), r1(1,0), r1(2,0));
    R1.yrow().set(r1(0,1), r1(1,1), r1(2,1));
    R1.zrow().set(r1(0,2), r1(1,2), r1(2,2));
    R2.xrow().set(r2(0,0), r2(1,0), r2(2,0));
    R2.yrow().set(r2(0,1), r2(1,1), r2(2,1));
    R2.zrow().set(r2(0,2), r2(1,2), r2(2,2));
