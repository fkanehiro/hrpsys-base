...
static const char* spec[] = {
    "implementation_id", "RangeNoiseMixer", "type_name", "RangeNoiseMixer",
    "description", "noise mixer for range data", "version",
...
void RangeNoiseMixerInit(RTC::Manager* manager) {
  ...
  manager->registerFactory(profile, RTC::Create<RangeNoiseMixer>,
