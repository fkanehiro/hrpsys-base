...
static const char *cameraimageviewercomponent_spec[] = {
    "implementation_id", "CameraImageViewer", "type_name", "CameraImageViewer",
    "description", "camera image viewer component", "version",
...
void CameraImageViewerInit(RTC::Manager *manager) {
  ...
  manager->registerFactory(profile, RTC::Create<CameraImageViewer>,
