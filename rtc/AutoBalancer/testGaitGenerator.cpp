...
public:
    ...
    void test1 ()
    {
        ...
        gg->go_pos_param_2_footstep_nodes_list(200*1e-3, 100*1e-3, 20, coordinates(leg_pos[0]), coordinates(leg_pos[1]), start_ref_coords, RLEG);
        gen_and_plot_walk_pattern();
    };
    ...
    void test2 ()
    {
        ...
        gg->go_pos_param_2_footstep_nodes_list(300*1e-3, 0, 0, coordinates(leg_pos[1]), coordinates(leg_pos[0]), start_ref_coords, LLEG);
        gen_and_plot_walk_pattern();
    };
    ...
    void test3 ()
    {
        ...
        coordinates start_ref_coords;
        mid_coords(start_ref_coords, 0.5, coordinates(leg_pos[0]), coordinates(leg_pos[1]));
        gg->go_pos_param_2_footstep_nodes_list(0, 150*1e-3, 0, coordinates(leg_pos[0]), coordinates(leg_pos[1]), start_ref_coords, RLEG);
        gen_and_plot_walk_pattern();
    };
    ...
    void test4 ()
    {
        ...
        coordinates start_ref_coords;
        mid_coords(start_ref_coords, 0.5, coordinates(leg_pos[1]), coordinates(leg_pos[0]));
        gg->go_pos_param_2_footstep_nodes_list(0, 0, 30, coordinates(leg_pos[1]), coordinates(leg_pos[0]), start_ref_coords, LLEG);
        gen_and_plot_walk_pattern();
    };
    ...
    void test7 ()
    {
        ...
        coordinates start_ref_coords;
        mid_coords(start_ref_coords, 0.5, coordinates(leg_pos[1]), coordinates(leg_pos[0]));
        gg->go_pos_param_2_footstep_nodes_list(100*1e-3, 0, 0, coordinates(leg_pos[1]), coordinates(leg_pos[0]), start_ref_coords, LLEG);
        gen_and_plot_walk_pattern();
    };
    ...
    void test8 ()
    {
        ...
        gg->go_pos_param_2_footstep_nodes_list(100*1e-3, 0, 0, coordinates(initial_foot_mid_rot*leg_pos[1], initial_foot_mid_rot), coordinates(initial_foot_mid_rot*leg_pos[0], initial_foot_mid_rot), start_ref_coords, LLEG);
