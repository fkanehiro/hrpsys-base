...
/**
   ...
   port
*/
class EmergencyStopper : public RTC::DataFlowComponentBase {
 public:
  /**
     \brief Constructor
 ...
 private:
  void get_wrenches_array_from_data(
      const std::vector<TimedDoubleSeq> &wrenches_data,
  ...
  void set_wrenches_data_from_array(std::vector<TimedDoubleSeq> &wrenches_data,
