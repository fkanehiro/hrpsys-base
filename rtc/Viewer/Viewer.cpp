...
static const char* component_spec[] = {
    "implementation_id", "Viewer", "type_name", "Viewer", "description",
    "viewer component", "version", HRPSYS_PACKAGE_VERSION, "vendor", "AIST",
...
void ViewerInit(RTC::Manager* manager) {
  ...
  manager->registerFactory(profile, RTC::Create<Viewer>, RTC::Delete<Viewer>);
}
};
