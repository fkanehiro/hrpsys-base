...
CORBA::Boolean ImpedanceControllerService_impl::startImpedanceController(
    const char *i_name_) {
  return m_impedance->startImpedanceController(std::string(i_name_));
}

CORBA::Boolean ImpedanceControllerService_impl::startImpedanceControllerNoWait(
    const char *i_name_) {
  return m_impedance->startImpedanceControllerNoWait(std::string(i_name_));
}

CORBA::Boolean ImpedanceControllerService_impl::stopImpedanceController(
    const char *i_name_) {
  return m_impedance->stopImpedanceController(std::string(i_name_));
}

CORBA::Boolean ImpedanceControllerService_impl::stopImpedanceControllerNoWait(
    const char *i_name_) {
  return m_impedance->stopImpedanceControllerNoWait(std::string(i_name_));
}

CORBA::Boolean ImpedanceControllerService_impl::setImpedanceControllerParam(
    const char *i_name_,
    const OpenHRP::ImpedanceControllerService::impedanceParam &i_param_) {
  return m_impedance->setImpedanceControllerParam(std::string(i_name_),
                                                  i_param_);
}

CORBA::Boolean ImpedanceControllerService_impl::getImpedanceControllerParam(
    const char *i_name_,
  ...
  return m_impedance->getImpedanceControllerParam(std::string(i_name_),
                                                  *i_param_);
}

void ImpedanceControllerService_impl::waitImpedanceControllerTransition(
    const char *i_name_) {
  m_impedance->waitImpedanceControllerTransition(std::string(i_name_));
}

void ImpedanceControllerService_impl::impedance(
