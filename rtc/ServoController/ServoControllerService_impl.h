...
class ServoControllerService_impl
  ...
  */
  ...
  CORBA::Boolean setJointAngle(const CORBA::Short id, CORBA::Double jv,
                               CORBA::Double tm);
  CORBA::Boolean setJointAngles(
  ...
  CORBA::Boolean setJointAnglesOfGroup(
      const char *gname, const OpenHRP::ServoControllerService::dSequence &jvs,
      CORBA::Double tm);

  CORBA::Boolean setMaxTorque(const CORBA::Short id,
  ...
  CORBA::Boolean getTemperature(const CORBA::Short id,
