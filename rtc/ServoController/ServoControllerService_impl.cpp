...
CORBA::Boolean ServoControllerService_impl::setJointAngles(
...
CORBA::Boolean ServoControllerService_impl::getJointAngles(
    OpenHRP::ServoControllerService::dSequence_out jvs) {
  return m_servo->getJointAngles(jvs);
}

CORBA::Boolean ServoControllerService_impl::addJointGroup(
    const char *gname, const OpenHRP::ServoControllerService::iSequence &ids) {
  return m_servo->addJointGroup(gname, ids);
}

CORBA::Boolean ServoControllerService_impl::removeJointGroup(
    const char *gname) {
  return m_servo->removeJointGroup(gname);
}

CORBA::Boolean ServoControllerService_impl::setJointAnglesOfGroup(
    const char *gname, const OpenHRP::ServoControllerService::dSequence &jvs,
    CORBA::Double tm) {
  return m_servo->setJointAnglesOfGroup(gname, jvs, tm);
}

CORBA::Boolean ServoControllerService_impl::setMaxTorque(
...
CORBA::Boolean ServoControllerService_impl::getDuration(
...
CORBA::Boolean ServoControllerService_impl::getMaxTorque(
...
CORBA::Boolean ServoControllerService_impl::getTemperature(
