...
static const char* cameraimageviewercomponent_spec[] = {
    "implementation_id", "RangeDataViewer", "type_name", "RangeDataViewer",
    "description", "range data viewer component", "version",
...
void RangeDataViewerInit(RTC::Manager* manager) {
  ...
  manager->registerFactory(profile, RTC::Create<RangeDataViewer>,
