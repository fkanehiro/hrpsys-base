...
CORBA::Boolean TorqueControllerService_impl::setTorqueControllerParam(const char *jointName, const OpenHRP::TorqueControllerService::torqueControllerParam& t_param)
{
    return m_torque_controller->setTorqueControllerParam(std::string(jointName), t_param);
}

CORBA::Boolean TorqueControllerService_impl::getTorqueControllerParam(const char *jointName, OpenHRP::TorqueControllerService::torqueControllerParam& t_param)
{
    return m_torque_controller->getTorqueControllerParam(std::string(jointName), t_param);
}
