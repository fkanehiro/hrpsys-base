...
// virtual RTC::ReturnCode_t onRateChanged(RTC::UniqueId ec_id);
  ...
  bool setTorqueControllerParam(const std::string jname, const OpenHRP::TorqueControllerService::torqueControllerParam& t_param);
  bool getTorqueControllerParam(const std::string jname, OpenHRP::TorqueControllerService::torqueControllerParam& t_param);
