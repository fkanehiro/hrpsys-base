...
#ifndef JOYSTICK2VELOCITY_H
#define JOYSTICK2VELOCITY_H
  ...
  : public RTC::DataFlowComponentBase
{
 ...
 private:
  int dummy, m_debugLevel;
  std::vector<unsigned int> m_axesIds;
  std::vector<double> m_scalesTranslation, m_scalesRotation;
