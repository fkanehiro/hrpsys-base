...
class AccelerationFilterService_impl
 ...
 public:
  ...
  ::CORBA::Boolean setAccelerationFilterParam(
      const ::OpenHRP::AccelerationFilterService::AccelerationFilterParam
          &i_param);
  ::CORBA::Boolean getAccelerationFilterParam(
      ::OpenHRP::AccelerationFilterService::AccelerationFilterParam_out
          i_param);
  ::CORBA::Boolean resetFilter(
      OpenHRP::AccelerationFilterService::ControlMode mode,
