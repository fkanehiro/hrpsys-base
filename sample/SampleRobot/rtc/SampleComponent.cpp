...
static const char* nullcomponent_spec[] = {
    "implementation_id", "SampleComponent", "type_name", "SampleComponent",
...
RTC::ReturnCode_t SampleComponent::onInitialize() {
  ...
  m_SampleComponentPort.registerProvider("service0", "SampleComponentService",
                                         m_service0);
...
void SampleComponentInit(RTC::Manager* manager) {
  ...
  manager->registerFactory(profile, RTC::Create<SampleComponent>,
